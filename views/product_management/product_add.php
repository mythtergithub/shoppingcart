  ...
  <div class="col-sm-6">
	<form id="frmADDITEM">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control field" id="item_price" name="item_price" data-old="" placeholder="Item Price" data-required="Please provide Item Price" value="1.00" currencyNumber />
			<span class="note"></span>
		</div>
		<div class="form-group">
